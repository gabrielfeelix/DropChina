...
const TopBar = () => (
  <div className="topbar">
    <div className="wrap topbar-inner">
      ...
      <div className="right">
        <a href="#"><I.whatsapp style={{verticalAlign: "-2px", marginRight: 6}} /> (11) 99999-9999</a>
        <a href="#">Atendimento · Seg–Sáb 8h–20h</a>
      </div>
    </div>
  </div>
);
...
const Logo = () => (
  <a href="DropChina Homepage.html" className="logo-link" aria-label="DropChina">
    ...
    <nav className="nav" onMouseLeave={closeMega}>
      <div className="wrap nav-inner">
        ...
        <div className="nav-secondary">
          ...
          <a href="#" onMouseEnter={() => setMegaOpen(false)}>Suporte</a>
