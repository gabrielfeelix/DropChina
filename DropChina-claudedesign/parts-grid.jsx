...
// =================
// Product placeholder art (per product)
// =================
const ProductArt = ({ tone, hint }) => {
  const palette = {
    ...
    <div className="card">
      <div className="card-media">
        ...
        <button className="card-quick" onClick={onAdd}>
          <I.cart style={{ width: 16, height: 16 }} /> Adicionar ao carrinho
        </button>
      </div>
      <div className="card-body">
        ...
        <div className="card-price-stack">
          {old && <span className="card-price-old">de {old}</span>}
        ...
        {p.shipping && (
          <div className="card-shipping">
            <span className="pulse" /> {p.shipping}
          </div>
        )}
      </div>
    </div>
...
Object.assign(window, { Categories, ProductCard, BestSellers, CouponStrip, ProductArt });
