...
## 🗺️ Mapa geral — TUDO que vamos criar
| # | O que criar | O que é (em português) | Pra que serve | Custo | Prioridade |
|---|---|---|---|---|---|
| 1 | **Identidade pública** | nome, @, bio, avatar, cores iguais em tudo | as pessoas reconhecerem a marca | grátis | 🔴 base |
| 2 | **Instagram Business** | perfil comercial no Insta | vitrine + público principal no BR | grátis | 🔴 base |
| 3 | **Página Facebook** | página ligada ao Insta | exige pra anúncio e catálogo depois | grátis | 🔴 base |
| 4 | **WhatsApp Business** | Whats da empresa com catálogo | atendimento + venda direta (87% abre msg) | grátis | 🔴 base |
| 5 | **Google Meu Negócio** | ficha da empresa no Google/Maps | aparecer quando buscam no Google + confiança | grátis | 🟠 alta |
| 6 | **Google Search Console** | painel do Google pro seu site | Google achar e indexar seus produtos | grátis | 🟠 alta |
| 7 | **Reviews (Reclame Aqui + Google)** | perfis de avaliação | prova social — consumidor checa antes de comprar | grátis | 🟠 alta |
...
### 1. Identidade pública (a base de tudo)
Antes de criar qualquer perfil, travar o básico pra tudo sair igual:
- **@handle único** em todas as redes (ex: `@dropchinaoficial`) — mesmo nome em toda parte.
- **Nome de exibição:** "DropChina" + o que vende ("Cartuchos, Toners e Informática").
- **Bio padrão** (mesma ideia em todo lugar): o que vende + diferencial + CTA. Ex:
  > 🖨️ Cartuchos, toners e informática com garantia · Envio em 24h · Atendimento no Whats 👇
- **Avatar** (logo, 1024×1024) e **cores/tom de voz** iguais — ver `../brand/`.
- **Link na bio:** uma página só com "Comprar / Falar no Whats / Ofertas" (dá pra fazer grátis).
> **Boa prática:** consistência = reconhecimento. A pessoa tem que bater o olho e saber que é você, seja no Insta, no Google ou no Whats.

### 2-4. As "casas" da marca (perfis)
- **Instagram Business:** vitrine principal. Perfil comercial (grátis) libera estatísticas e botão de contato. É onde mora o conteúdo.
- **Página Facebook:** hoje pouca gente "usa" o FB, mas a página é **obrigatória** pra rodar anúncio, catálogo e Instagram Shopping depois. Cria e vincula ao Insta, deixa pronta.
- **WhatsApp Business:** o canal que mais converte no BR. Configurar: catálogo com os top produtos, **mensagem de saudação** automática, **respostas rápidas** (dúvidas de compatibilidade), horário de atendimento. O nº oficial é **41 99534-2751**.
...
**O que é:** o painel oficial do Google pro dono do site. Mostra por quais buscas você aparece e avisa se tem problema de indexação.
**Por que:** garante que o Google **acha e lista seus produtos** de graça. O Shopify já gera o mapa do site (sitemap); a gente só verifica o domínio e envia.
> **Boa prática (SEO grátis):** títulos e descrições com as palavras que as pessoas buscam ("toner HP 105A compatível"), textos nas categorias, FAQ. Muito disso o chat Shopify já implementou — a gente só mantém e amplia.
...
Detalhe completo no runbook: **`../marketing/setup-tagueamento.md`**. Resumo: GA4 (funil), GTM (central de tags), Meta Pixel (público pra ads depois), Microsoft Clarity (heatmap grátis), banner LGPD (obrigatório no BR). Sem medir, a gente decide no achismo.
...
### 10-12. Fase 2 (quando o de cima rodar)
- **TikTok:** algoritmo dá alcance pra conta nova; reels de comparativo/dica vão bem.
- **Blog/guias no site:** artigos tipo "original vs compatível" ranqueiam no Google e fazem a **IA (ChatGPT/Gemini) citar a DropChina** — mercado que cresce 30%/ano e hoje a loja é invisível nele.
- **YouTube:** tutoriais curtos ("como trocar o toner da HP") rankeiam por anos.

---

## ⭐ Boas práticas do orgânico (as regras de ouro)
1. **Consistência > intensidade.** 3 posts/semana pra sempre bate 20 posts numa semana e sumir.
2. **Dar antes de pedir.** 80% conteúdo que ajuda (dica, comparativo), 20% oferta. Ninguém segue vendedor chato.
3. **Hook nos 3 primeiros segundos.** No reel, se não fisgar na hora, a pessoa rola. Texto grande na tela.
4. **Um CTA por post.** Salvar, comentar, ou chamar no Whats — nunca os três juntos.
5. **Responder tudo.** Comentário e DM respondidos = o algoritmo entrega mais + vira relacionamento.
6. **Falar a língua do cliente.** "Qual toner serve na minha impressora?" é como ele pensa — não "suprimentos de impressão".
7. **Reaproveitar.** 1 vídeo vira reel + story + post no FB + corte pro TikTok. Trabalha uma vez, publica em cinco.
8. **Prova social sempre.** Print de cliente satisfeito, "X vendas no Mercado Livre", avaliação real — confiança vende.
9. **Medir e dobrar no que funciona.** Olhar o que teve mais alcance/salvamento e fazer mais daquilo.
10. **Paciência de bola de neve.** Orgânico rende juros. Os primeiros 90 dias são de plantio.

---

## 📅 Semana típica (quando estiver rodando)
- **3-5 posts/semana** no Insta (carrossel educativo + reel de alcance) — pauta em `conteudo/`.
- **Stories quase diários** (bastidor, enquete, dica rápida) — barato e mantém a marca viva.
- **1 oferta/semana** no Google Meu Negócio + story.
- **Responder** comentários/DM/Whats no mesmo dia.
- **Pedir avaliação** a cada cliente atendido.

---

## 🔗 Arquivos da frente
- Estado e próximos passos: `STATUS.md`
- Roadmap faseado: `plano-crescimento.md`
- Pauta e posts: `conteudo/calendario-editorial.md` · `conteudo/posts-prontos.md`
- Contas e IDs: `contas-e-acessos.md`
- Tagueamento (técnico): `../marketing/setup-tagueamento.md`
